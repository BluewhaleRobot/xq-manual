...
rviz
```
![0_1488360661097_open0.PNG](/uploads/files/1488360662120-open0-resized.png) 
#### 等待几秒，正常情况会出现下图的类似结果
![0_1488360723640_open1.PNG](/uploads/files/1488360737623-open1-resized.png) 
### 3、遥控小强运动开始建图
...
![0_1488360995085_open2.PNG](/uploads/files/1488360995733-open2-resized.png) 
### 4、保存地图，本文结束
...
```
![0_1488361203373_open3.PNG](/uploads/files/1488361203759-open3-resized.png)
